...
export const CATEGORY_ALT_TEXTS: Record<string, string> = {
  ...
  colliers: 'Collection de colliers en acier inoxydable INOXYA',
  ...
  montres: 'Collection de montres élégantes en acier inoxydable INOXYA',
  parures: 'Collection de parures et ensembles en acier inoxydable INOXYA',
