/**
 * Script pour ajouter 7 NOUVEAUX produits (Gourmettes)
 * SANS modifier, supprimer ou toucher aux 21 produits existants
 */
...
console.log('🚀 Ajout de 7 nouveaux produits GOURMETTES INOXYA...\n')
console.log('='.repeat(80))

try {
  // 1. Vérifier qu'il y a bien 21 produits existants
  ...
  if (existingCount.count !== 21) {
    console.warn(`   ⚠️  Attention: ${existingCount.count} produits trouvés (attendu: 21)`)
    console.log('   ℹ️  Le script continuera quand même...')
  } else {
    console.log('   ✅ 21 produits existants confirmés')
  }
  ...
  // 4. Définir les 7 nouveaux produits (Gourmettes)
  console.log('\n4️⃣ Préparation des 7 nouveaux produits (Gourmettes)...')
  
  const newProducts = [
    {
      name: 'Gourmette Encre',
      original_price: 199,
      current_price: 89,
      main_image: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 7.jpeg',
      secondary_image_1: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 7.3.jpeg',
      secondary_image_2: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 7.2.jpeg'
    },
    {
      name: 'Gourmette Diva',
      original_price: 110,
      current_price: 79,
      main_image: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 6.jpeg',
      secondary_image_1: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 6.3.jpeg',
      secondary_image_2: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 6.2.jpeg'
    },
    {
      name: 'Gourmette Majesté',
      original_price: 130,
      current_price: 99,
      main_image: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 5.jpeg',
      secondary_image_1: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 5.3.jpeg',
      secondary_image_2: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 5.2.jpeg'
    },
    {
      name: 'Gourmette Luxa',
      original_price: 100,
      current_price: 69,
      main_image: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 4.jpeg',
      secondary_image_1: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 4.3.jpeg',
      secondary_image_2: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 4.2.jpeg'
    },
    {
      name: 'Gourmette Royale',
      original_price: 160,
      current_price: 109,
      main_image: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 3.jpeg',
      secondary_image_1: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 3.3.jpeg',
      secondary_image_2: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 3.2.jpeg'
    },
    {
      name: 'Gourmette Perla',
      original_price: 160,
      current_price: 109,
      main_image: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 2.jpeg',
      secondary_image_1: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 2.3.jpeg',
      secondary_image_2: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 2.2.jpeg'
    },
    {
      name: 'Gourmette Célestine',
      original_price: 110,
      current_price: 89,
      main_image: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette 1.jpeg',
      secondary_image_1: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette1.3.jpeg',
      secondary_image_2: 'C:\\Users\\hassa\\Desktop\\image inoxya\\gourmette1.2.jpeg'
    }
  ]
  ...
  newProducts.forEach((product, index) => {
    try {
      ...
      insertProduct.run(
        product.name,
        `Gourmette élégante ${product.name} - Bijou en acier inoxydable de qualité supérieure`,
        product.current_price,
        product.original_price,
        'Bracelets', // Catégorie pour les gourmettes
        10, // stock par défaut
        1, // is_active
        mainImageUrl,
      ...
      console.log(`      ✅ Produit inséré avec succès (ID: ${db.prepare('SELECT last_insert_rowid() as id').get().id})`)
      successCount++
    } catch (error) {
  ...
  console.log('\n   📋 Liste des nouveaux produits (Gourmettes):')
  newProductsInDb.forEach(p => {
