...
function useFAQData() {
  ...
  const faqData = [
    {
      ...
      answerLinks: [
        { text: t('links.collection'), href: `/${locale}/bijoux` }
      ],
      icon: Gem,
    ...
    },
    {
      ...
      answerLinks: [
        { text: t('links.surMesure'), href: `/${locale}/sur-mesure` }
      ],
      icon: Sparkles,
    ...
    },
    {
      ...
      answerLinks: [
        { text: t('links.packs'), href: `/${locale}/packs` }
      ],
      icon: Gem,
      category: t('categories.products')
    },
  ...
  const categories = [
    t('categories.all'),
    t('categories.delivery'),
    t('categories.payment'),
    t('categories.products'),
    t('categories.returns'),
    t('categories.custom'),
...
export default function FAQClient() {
  const { faqData, categories } = useFAQData()
  const locale = useLocale()
  const t = useTranslations('faq')
  ...
  }, [searchQuery, selectedCategory, faqData, allCategoryLabel])
